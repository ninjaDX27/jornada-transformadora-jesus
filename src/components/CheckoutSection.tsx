      ...
      <div className="container mx-auto max-w-full">
        <div className="max-w-xl sm:max-w-2xl mx-auto">
          <div className="text-center mb-6 sm:mb-8 md:mb-12">
            <div className="inline-block bg-green-500 text-white px-3 py-2 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full font-bold text-xs sm:text-sm md:text-lg mb-4 sm:mb-6 animate-bounce">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <Input
                  ...
                  required
                  className="border-2 border-gray-300 focus:border-amber-500 text-gray-800 h-10 sm:h-12 text-sm sm:text-base"
                  placeholder="Como você gostaria de ser chamado?"
                />
              </div>
              
              <div>
                <Label htmlFor="email" className="text-gray-700 font-medium mb-1 sm:mb-2 block text-xs sm:text-sm md:text-base">
                  Seu Melhor E-mail *
                </Label>
                <Input
                  id="email"
                ...
                />
                <p className="text-xxs sm:text-xs text-gray-600 mt-0.5 sm:mt-1">
                  📧 Seu eBook será enviado instantaneamente para este e-mail
                </p>
              </div>
              
              <div>
                <Label htmlFor="phone" className="text-gray-700 font-medium mb-1 sm:mb-2 block text-xs sm:text-sm md:text-base">
                  WhatsApp (opcional)
                </Label>
                <Input
                  id="phone"
